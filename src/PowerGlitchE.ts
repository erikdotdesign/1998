// Made by Benjamin Raymond 2022
// https://github.com/7PH/powerglitch.git
// I just added the data-glitch-ignore line
...
const glitchElement = (element: HTMLElement, layers: LayerDefinition[], options: PowerGlitchOptions): { container: HTMLDivElement, startGlitch: () => void, stopGlitch: () => void } => {
    ...
    // Remove ignored subtrees from clones
    baseLayer.querySelectorAll('[data-glitch-ignore]').forEach(el => el.remove());
    // Stack this layer
